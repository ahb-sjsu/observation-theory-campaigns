...
| 🔵 RG | Renormalization | Is universality a property of the substrate or of the declared coarse-graining channel? | RG-0..2b measured (two honest FAILs, both named): correlation length consumer-selected; the flip present but thin in RG form; RG-3..4 designed |
| ⚫ QD | Quantum Darwinism | Is objectivity multi-consumer redundancy, and does it emerge or must it be declared? | QD-0..2 measured: redundancy declared-or-absent, recency-record finding, budget-is-a-portfolio ratio 36; QD-3 designed |
| 🟠 HD | Hydrodynamics | Is a transport coefficient substrate or prescription, and is coarse dissipation entirely the observer's? | HD-0/HD-1/HD-1b/HD-2 measured (HD-1 honest FAIL = HPP's spurious invariants, exactly): FHP-I relaxes the shear HPP froze, and the viscosity is prescription-INVARIANT (spread 0.07% across nine prescriptions vs the 10% bar); HD-3 designed |
| 🔴 FT | Fluctuation theorems | What happens to Jarzynski and Crooks for a consumer with a restricted channel? | FT-0..2 measured: defect strictly between full sight and blindness; identity restored EXACTLY by inference through the true channel, degraded by a wrong one; FT-3 designed |
| 🟤 GG | Gauge redundancy | Is gauge symmetry anything but the fiber structure of the observer's projection? | GG-0..2b measured: observer bookkeeping = relabeled invariant loops; constraint an isolated point, invariants fourth-order blind; GG-3 designed |
