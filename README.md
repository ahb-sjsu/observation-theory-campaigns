...
|---|---|---|---|
| 🟦 PF | Projection folds | Can a fold in how hidden motion maps to observed time imitate particle pair creation, quantitatively? | PF-0..4 done (PF4-002 sealed negative; PF4-003 sealed unevaluable, family empty); PF-5 and PF-6 instruments ready, sealed gate runs + PF-7 remain; PF-8 decay gate designed (parity obstruction + blind-consumer loophole), gated |
