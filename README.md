...
| 🔴 FT | Fluctuation theorems | What happens to Jarzynski and Crooks for a consumer with a restricted channel? | COMPLETE first pass: FT-0..3 measured: fluctuation identities are inference theorems; the information term is the acting consumer's (Sagawa-Ueda exact, bystander fails) |
