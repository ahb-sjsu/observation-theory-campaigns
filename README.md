...
| 🔐 CR | Engineered observation limits | Cryptography declares the observer's channel on purpose, so which of its security statements are consumer-relative bookkeeping and which are substrate facts? | CR-0..5 measured: plateau is a step, ordering by proof, the flip 268/268 in leakage form, task-relative entropy, and the audit ceiling — leakage visible, trapdoors invisible by a bound, provenance auditable by counting |
