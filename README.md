...
claims remain unclaimed after two seals and EC7-003 (analytic Lyapunov
effort matching) is designated. Verification: `python python/verify_ec_gates.py`
