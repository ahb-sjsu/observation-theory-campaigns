...
|---|---|---|---|
| 🟦 PF | Projection folds | Can a fold in how hidden motion maps to observed time imitate particle pair creation, quantitatively? | PF-0..4 done (PF4-002 sealed negative; PF4-003 sealed unevaluable; PF4-004 probe: pulse-train family EMPTY across the probed region, summit closed on this family); PF-5 gate sealed and run (PASS on bars, vacuous on content — PF5-002 with probe-placed cells in preparation), PF-6 gate binds after it; PF-8 decay gate designed (parity obstruction + blind-consumer loophole), gated |
