...
| 🔭 OD | Observational discovery | Do the read operator, the evaluator, and the sealed loop, run as one, find laws about observation that survive every declared observer, starting from the budgeted observability theorem? | Design draft opened 2026-09-09, unsealed, non-claim-bearing: gates D0 theorem in Lean, D1 identifiability at a budget, D2 the observer-relative hubness law, D3 the observational predictability horizon, D4 the geometry of the program's own searches, D5 Burgers shock formation with resolution and budget separated; `experiments/DISCOVERY-TRACK.md` |
