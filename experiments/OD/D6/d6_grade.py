"""Grades a D6 results.json against the sealed bars of PREREG-D6.md.
...
def grade(res: dict, tols: dict) -> dict:
    ...
    e1, p1, g1, c1, c2, h1 = [None if b is None else bool(b) for b in (e1, p1, g1, c1, c2, h1)]
    for k in ("E1_antitone", "P1_reaches_count", "G1_greedy_vs_exhaustive", "C1_vs_energy", "C2_vs_random", "H1_horizon"):
