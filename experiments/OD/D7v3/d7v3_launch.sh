...
cd /archive/ahb-sjsu/observation-theory-campaigns/experiments/OD/D7v3 || exit 1
...
echo "== start $(date) HEAD $(git rev-parse --short HEAD) role $ROLE seal $(git hash-object PREREG-D7V3.md 2>/dev/null)"
