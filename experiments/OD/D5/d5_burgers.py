"""D5: Burgers shock formation as the first singular test (OD track, gate D5).
...
def run_ns_control(world: dict, cfg: dict, seed: int, log=print) -> dict:
    ...
    for i in range(int(t_end / sample) + 1):
        rec["t"].append(t); rec["max_grad"].append(model.max_grad(wh))
