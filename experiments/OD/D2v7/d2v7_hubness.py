"""D2v7: observer-relative hubness, the law with the Poisson hub excess as the target (OD track,
...
real corpora and the scale cells; it never refits.
    ...
    python d2v7_hubness.py --selftest
...
def run(cfg: dict, seed_role: str, out_path: str, discover_path: str | None, law_path: str | None) -> dict:
    ...
    if discover_path:
        ...
        frozen = {"law": law, "competitor_nominal": comp, "competitor_unity": UNITY_LAW, "target": target, "frozen_from": seed_role, "seed": seed, "n_train": len(train), "n_heldout": len(held),
