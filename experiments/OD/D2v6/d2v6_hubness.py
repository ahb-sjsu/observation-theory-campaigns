...
real corpora and the scale cells; it never refits.
    ...
    python d2v6_hubness.py --selftest
...
def run(cfg: dict, seed_role: str, out_path: str, discover_path: str | None, law_path: str | None) -> dict:
    ...
    if discover_path:
        ...
        frozen = {"law": law, "competitor_nominal": comp, "competitor_d2": D2_FROZEN_LAW, "competitor_d2v2": D2V2_FROZEN_LAW, "competitor_d2v3": D2V3_FROZEN_LAW, "competitor_d2v4": D2V4_FROZEN_LAW, "competitor_d2v5": D2V5_FROZEN_LAW, "target": target, "frozen_from": seed_role, "seed": seed, "n_train": len(train), "n_heldout": len(held),
    ...
    if law_path:
        ...
        for w in result["worlds"]:
            ...
            result["evaluation"][w["name"]] = {"group": w["group"], "rmse_law": rmse(frozen["law"], rs), "rmse_competitor": rmse(frozen["competitor_nominal"], rs), "rmse_d2_law": rmse(frozen["competitor_d2"], rs), "rmse_d2v2_law": rmse(frozen["competitor_d2v2"], rs), "rmse_d2v3_law": rmse(frozen["competitor_d2v3"], rs), "rmse_d2v4_law": rmse(frozen["competitor_d2v4"], rs), "rmse_d2v5_law": rmse(frozen["competitor_d2v5"], rs), "n": len(rs)}
