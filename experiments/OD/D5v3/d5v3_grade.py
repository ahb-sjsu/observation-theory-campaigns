"""Grades a D5v3 results.json against the sealed bars of PREREG-D5V3.md. D5v2's grader with the convergence bar N1 taken
...
Usage: python d5v3_grade.py results.json --tols tolerances.json [--out grade.json]
