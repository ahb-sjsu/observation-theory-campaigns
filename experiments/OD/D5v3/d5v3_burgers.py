"""D5v3: D5v2's workload unchanged, renamed for the registration. D5v2: the observer-relative transition in Burgers shock formation as a law (OD track, gate D5v2), the D5
