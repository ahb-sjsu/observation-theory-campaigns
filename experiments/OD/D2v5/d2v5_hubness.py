"""D2v5: observer-relative hubness, the law with a tail variable measured on the neighbour
...
real corpora and the scale cells; it never refits.
    ...
    python d2v5_hubness.py --selftest
...
def run(cfg: dict, seed_role: str, out_path: str, discover_path: str | None, law_path: str | None) -> dict:
    ...
    if discover_path:
        ...
        frozen = {"law": law, "competitor_nominal": comp, "competitor_d2": D2_FROZEN_LAW, "competitor_d2v2": D2V2_FROZEN_LAW, "competitor_d2v3": D2V3_FROZEN_LAW, "competitor_d2v4": D2V4_FROZEN_LAW, "target": target, "frozen_from": seed_role, "seed": seed, "n_train": len(train), "n_heldout": len(held),
