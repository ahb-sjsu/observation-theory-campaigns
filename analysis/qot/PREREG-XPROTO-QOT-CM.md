...
20260829, 20260830}, disjoint from the shakedown's {0,1,2}. Substrate = fam_qot's
...
## Family F-QOT-CM (constructed + shaken down 2026-08-27)
...
nominal. The rebalancing is tiny, and that is itself informative: on this substrate
nominal dB matching is within ~1.7% of true capacity matching, and the ~1.6% margin
rescaling moved no false-clear at all (deltas and lambda* unchanged to 4 decimals,
shift 0.0000). Runtime: ~1 s for the three cells + ~1 s GNPy comb precompute.
Shakedown numbers stand in for nothing beyond code correctness.

## Seal procedure

On 2026-08-28+: reread this prereg, flip STATUS to SEALED, commit; run
`fam_qotcm.py --graded --seeds 20260828 20260829 20260830` in the qot venv; write
