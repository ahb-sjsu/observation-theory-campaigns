...
Degenerate & constant & conserved & none \\
monotone & & & \\
Fold & jumps by two & conserved & one new binary \\
 & & & distinction \\
\colrule
Cusp & varies across & conserved & correlated branch \\
 & fold boundaries & globally & ambiguity (open) \\
Higher & larger structured & constrained & multiway ambiguity \\
catastrophes & changes & & (open) \\
\end{tabular}
\end{ruledtabular}
\end{table}
