...
`lean/DataMiningAsObservation/ReliabilityWeight.lean`, theorems `pair_le_one`, `aurocNum_le`, `auroc_le_one`, `weight_mem_unit`, `weight_eq_zero_of_le_half`, `weight_comp`, at observation-data-mining f05f3e7.
