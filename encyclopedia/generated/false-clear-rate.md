...
From `observation-theory-campaigns/experiments/DATABASE-FRESHNESS-TRACK.md` at 27b21e4.
...
From `observation-theory-campaigns/experiments/RADIO-FRESHNESS-TRACK.md` at 27b21e4.
...
`lean/DataMiningAsObservation/Certificate.lean`, theorems `falseClear_mul_coverage`, `coverage_empty`, `falseClear_mem_unit`, `minOverStrata_passes_iff`, `minOverStrata_le_weighted_mean`, at observation-data-mining 49fcb16.
