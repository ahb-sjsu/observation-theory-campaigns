...
`lean/DataMiningAsObservation/CommuteTime.lean`, theorems `commute_symm`, `commute_self`, `resistance_symm`, `commute_eq_resistance_mul`, `collapsed_congr`, `collapsed_const`, at observation-data-mining 17f3e9f.
