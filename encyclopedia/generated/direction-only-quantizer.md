...
[`lean/DataMiningAsObservation/DirectionQuantizer.lean`](https://github.com/ahb-sjsu/observation-data-mining/blob/f3914f0/lean/DataMiningAsObservation/DirectionQuantizer.lean), theorems `length_preserved`, `score_eq`, `score_error`, `cosine_eq`, at observation-data-mining f3914f0; what the check covers is stated in the book's [appendix C](https://github.com/ahb-sjsu/observation-data-mining/blob/f3914f0/chapters/machine_checked.md).
