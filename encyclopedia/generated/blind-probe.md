...
- *measures.* GO-B-Llama `[predicted]`. Trained frontier LLM (Llama-3.2-3B), softmax-attention consumer — blind probe on real post-RoPE keys [`geometric-observation/claims/LEDGER.md:115`](https://github.com/ahb-sjsu/geometric-observation/blob/0792c84/claims/LEDGER.md#L115).
