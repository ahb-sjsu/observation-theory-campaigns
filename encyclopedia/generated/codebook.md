...
`lean/DataMiningAsObservation/Codebook.lean`, theorems `distortion_nonneg`, `distortion_codeword`, `distortion_anti`, `exists_nearest`, at observation-data-mining f05f3e7.
