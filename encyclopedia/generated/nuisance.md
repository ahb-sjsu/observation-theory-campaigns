...
- NEG-7. Per-channel quantization is universally the invariant-preserving arm for softmax-key attention (a compressor property). `[refuted]`. `geometric-observation/claims/LEDGER.md:100` at 8c6986b.
