...
`lean/DataMiningAsObservation/GeodesicDistance.lean`, theorems `dist_self`, `dist_comm`, `dist_triangle`, `dist_adj`, `geodesic_rank_invariant`, at observation-data-mining f05f3e7.
