...
- GO-5. An α=1 density/hubness quotient restores invariant fidelity in ≥1 non-spectral domain. `[refuted]`. `geometric-observation/claims/LEDGER.md:67` at 8c6986b.
...
`lean/DataMiningAsObservation/Hubness.lean`, theorems `sum_count`, `sum_count_eq`, `count_congr`, `antiHub_iff`, at observation-data-mining 17f3e9f.
