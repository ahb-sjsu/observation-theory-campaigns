...
other eighty exist only as generated entries, built from the records by `generate.py`.
...
its checkable core, sixty-three files as of 2026-09-04, and the book's appendix C states what each
